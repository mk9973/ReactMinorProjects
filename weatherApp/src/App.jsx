...
function App() {
  ...
  const API_KEY = "13b3519100b39ab4e2c3698e1d850c35"; // Replace 'YOUR_API_KEY' with your actual API key from OpenWeatherMap
  ...
  const getWeatherIconUrl = (main) => {
    switch (main) {
      ...
      case "Clouds":
        return "/rain_with_cloud.png"; // Path to your snowy weather icon
      case "Haze":
